...
- **Dos sitios para volver a elegir**: el enlace «Preferencias de cookies» del
  ...
  nacen con `hidden`. Va a la izquierda porque a la derecha ya están WhatsApp
...
| `consentimiento.js` | **Va el último en las seis páginas.** El interruptor de los píxeles de Meta y Google Ads (`AJUSTES`, vacío = apagado), la lectura de la decisión guardada, cuándo preguntar (tras el vídeo o la cortina) y la carga del paquete perezoso del aviso. Ver «Cookies y píxeles de publicidad». |
