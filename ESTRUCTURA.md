...
| `09-cierre-cta.css` | Cierre cine y banda final con llamada a la acción. La pregunta va **suelta sobre la mampostería, sin recuadro** —lo llevó una temporada y encerraba el cierre—, así que la legibilidad la pone entera el velo: dos capas, la vertical que baja el conjunto y una horizontal que carga la mitad izquierda, donde está la pregunta, y suelta la derecha, donde solo hay un botón con su propio filo de oro. Apilado en móvil el degradado lateral estorba y se cambia por uno vertical más pesado. | `.cierre-cine*`, `.banda-cta*` |
...
|---|---|
| `madera.webp` (+ `-960`) | Las tres superficies cálidas del sitio, que a propósito son la misma: Testimonios en la portada, el panel de Fundamentos en Nosotros y el hero de Galería y de FAQ. Y una cuarta: **la media pantalla del elenco de Nosotros**, donde el profesional recortado necesita una superficie oscura contra la que recortarse. Todas van ya a opacidad 1 y lo que las diferencia es el velo de encima: en Testimonios y en los heros de Galería y FAQ apenas se toca —la madera *es* la sección—, en el elenco baja un poco el brillo para que la figura mande, y en Fundamentos pesa más, que detrás lleva dos columnas de texto largo. El ajuste vive en la hoja de cada pieza. |
