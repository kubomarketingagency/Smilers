...
| `13-testimonios.css` | La esfera de testimonios, su versión en tarjetas y el fondo de **madera** que va detrás de las dos. La madera va entera (`opacity: 1`), y no como iba el jardín, que era una foto que mirar y por eso iba tenue y aclarada: la madera es una superficie, la veta es todo lo que tiene, y con aquellos ajustes se apagaba hasta quedar en negro. **Sin halo de oro encima**: lo llevaba al 13% y sobre una madera wengú eso no la encendía, le lavaba la veta del centro justo donde más se ve y la dejaba con aspecto de foto vieja. Lo único que queda encima es el negro de los cantos, que la cose con las secciones vecinas. La palabra «Testimonios» va en su caja de oro (`.caja-oro`, del 22): la letra se decide en `.testimonios-etiqueta` y la caja la hereda; va **un punto por debajo del rótulo de las otras secciones y pegado al canto de la barra fija**, que entre el cuerpo grande y la caja alrededor eran cien píxeles de cartel en lo alto de una pantalla cuyo asunto es una cara. **En el teléfono no hay esfera: hay foto** (`.modo-foto`, que pone el guion por debajo de 992). La esfera enseña un disco —la foto recortada en cuadrado por el centro y, dentro, un círculo—, y con fotos de media figura eso corta por los hombros y mete a la persona en un ojo de buey; en una pantalla de mano, donde la foto es lo único que hay, se ve entera. El marco se acomoda a ella, apaisada o de pie, el botón de revelar la cubre entera —se toca el propio retrato— con su chapa metida dentro, que debajo está la cita, y la pista de toque deja de ser un anillo (lo era porque se tocaba un disco) y pasa a ser un pulso en el canto de la foto. | `.testimonios-*`, `.tst-*`, `.tc-*` |
