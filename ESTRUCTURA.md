...
La muela de oro de los heros (`imagenes/muela-oro-480.webp` y `-240`) sale
de `imagenes/originales/muela-oro-original.png`: recortada a su contorno y
con el borde afilado (el original llegó borroso, con el filo repartido en ocho
píxeles), al doble antes de afilar y con el oro extendido hacia el borde para
que no quede un halo oscuro.
