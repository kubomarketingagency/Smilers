...
| `marmol-negro-barra.webp` | La barra de navegación, en las cinco páginas, y las dos **franjas de piedra** (`.franja-piedra`): los filtros de la Galería y el rótulo de cada bloque de preguntas de FAQ. Es una tira recortada del mármol negro, de 1920×130, para no cargar la imagen entera por 60px de alto. |
