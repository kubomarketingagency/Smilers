...
plano del 9%**, y nada más. La portada es la excepción: **16%**, porque es
la única cinta que se ve entera nada más abrir y le sienta bien quedar un
punto sentada. (Pasaron una temporada por 3% y 7%: las fotos se veían, pero
el conjunto quedaba demasiado encendido, y se subió a la vez que los
recuadros.)
...
`.ns-cine__texto` (92→84%), `.bp-panel` del hero de Tratamientos (92→84%),
`.cierre-cine … .row::before` (radial 90→50%), `.ns-cifras::before` (76→10%)
y `.ns-cta::before` (90→30%) de la banda de Nosotros. Los botones que caen
sobre foto llevan su propio suelo al 82%. Y las dos piezas que no van sobre
foto también subieron con ellos: las tarjetas de FAQ al 90% (95% abierta) y
la placa clara de la bajada de Especialidades al 92→80% de blanco. Un recuadro pesa donde hay letra y
