...
plano del 3%**, y nada más. La portada es la excepción: **7%**, porque es la
única cinta que se ve entera nada más abrir y le sienta bien quedar un punto
sentada.
...
`.ns-cine__texto` (84→74%), `.bp-panel` del hero de Tratamientos (84→74%),
`.cierre-cine … .row::before` (radial 84→34%), `.ns-cifras::before` y
`.ns-cta::before` de la banda de Nosotros. Un recuadro pesa donde hay letra y
...
velo razonable. Medido con el 3%, el titular da 13,5:1 y la bajada 9,6:1.
